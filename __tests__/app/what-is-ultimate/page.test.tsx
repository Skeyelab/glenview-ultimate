...
describe('WhatIsUltimatePage', () => {
  ...
  it('renders placeholder indicators for YouTube videos', () => {
    render(<WhatIsUltimatePage />);
    const placeholders = screen.getAllByText(/YouTube Video Embed/i);
    expect(placeholders).toHaveLength(4);
  });

  it('renders a note about videos coming soon', () => {
    render(<WhatIsUltimatePage />);
